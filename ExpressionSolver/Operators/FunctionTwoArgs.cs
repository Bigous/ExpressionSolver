...
/// <summary>
/// Represents a function operator that accepts two arguments in a mathematical expression.
...
/// <param name="func">The delegate that computes the function result given the two parameters.</param>
public class FunctionTwoArgs(string name, IExpression parameter1, IExpression parameter2, Func<IExpression, IExpression, decimal> func) : IFunction
{
    /// <inheritdoc/>
    ...
    /// <summary>
    /// Returns a string that represents the current function call with its two arguments.
    /// </summary>
